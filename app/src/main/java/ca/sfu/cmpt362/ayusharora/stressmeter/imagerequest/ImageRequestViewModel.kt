...
class ImageRequestViewModel : ViewModel() {
    ...
    // To store the point of music pause
    private var musicStartPoint = 0

    // To vibrate the phone
    private var vibrator: Vibrator? = null

    // To avoid double vibration on changing parent activity/fragment state
    ...
    // Pause the MediaPlayer and store the pause point
    fun pauseMusic() {
        musicStartPoint = mediaPlayer?.currentPosition ?: 0
        mediaPlayer?.pause()
    }

    // Resume the MediaPlayer from the pause point
    fun resumeMusic(){
    ...
    // Pause vibration according to activity/fragment  lifecycle
    fun stopVibration() {
        vibrator?.cancel()
        isVibrating = false
    }
